public class Main {
  public static void main(String[] args) {
      ...
      // Step 5 - Check for the following values. Display true or false depending on whether the map has the key.
      ...
      System.out.println("All values in the map after removal: " + creditHours);
  }
}
